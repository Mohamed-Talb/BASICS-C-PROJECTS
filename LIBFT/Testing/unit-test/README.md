...
In other words if something is broken and you want to fix it, the only thing you have to do is [create a pull request](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/proposing-changes-to-your-work-with-pull-requests/creating-a-pull-request-from-a-fork)
# Installation
...
Color | Meaning
--- | ---
Red | The function did not behaved correctly or crashed during the test. Orange | The function exceeded the maximal execution time, Probably due to an infinite loop.
